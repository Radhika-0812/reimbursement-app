        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            {showNavLinks && (
              <div className="hidden md:flex items-center gap-4">
                {/* Users see the normal links; Admins see nothing here */}
                {!isAdmin && (
                  <>
          ...
          {showNavLinks && (
            <div className="flex items-center gap-2">
              ...
              {/* profile menu (admins: only Profile + Logout) */}
        ...
        {showNavLinks && !isAdmin && menuOpen && (
          <div className="md:hidden pb-3">
            <div className="flex flex-col gap-2 pt-2">
              ...
              <button onClick={() => { setMenuOpen(false); navigate("/create"); }} className="text-white text-left">New Claim</button>
              <button onClick={() => { setMenuOpen(false); navigate("/pending"); }} className="text-white text-left">Pending Claims</button>
              <button onClick={() => { setMenuOpen(false); navigate("/closed"); }} className="text-white text-left">Closed Claims</button>
            </div>
          </div>
        )}
      </nav>
